...
import com.example.springbootwebapi.repository.employeeRepository.EmployeeRepository;
...
public class EmployeeController {
    ...
    @GetMapping("/employees/helloMiki")
    public String saySomething() {
        return "I am learning spring boot";
    }

    @GetMapping("/employees/hello/Miki")
    public String saySomething1() {
        return "miki speaking here";
    }
